...
public record BulkUpdateStudentRequestDto
{
...
public class BulkUpdateStudentRequestDtoValidator : AbstractValidator<BulkUpdateStudentRequestDto>
{
    public BulkUpdateStudentRequestDtoValidator()
    {
